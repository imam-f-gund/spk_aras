...
@section('content')
    <div class="container">
        ...
        <!-- <div class="modal" id="tambahDataUser" tabindex="-1" role="dialog" aria-labelledby="tambahDataUserLabel"
            aria-hidden="true">
        ...
        <div class="modal" id="ubahDataUser" tabindex="-1" role="dialog" aria-labelledby="tambahDataUserLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="tambahDataUserLabel">Ubah Data User</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
